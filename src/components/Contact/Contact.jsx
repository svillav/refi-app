  ...
  return (
    <section id="contacto" className="contact-section">
      <Container className="contact-info">
        <Row className="flex-md-row flex-column d-flex align-items-center">
            ...
            <div>
              ...
              <div className="contact-details">
                <div className="item">
                  ...
                  <span>
                    <a href="https://www.instagram.com/refi.comunidad/">@refi.comunidad</a>
                  </span>
                </div>
                <div className="item">
                  <div>
