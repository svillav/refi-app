...
import PDF from '../assets/periodico-refi-junio.pdf';
import imagePDF from '../assets/periodico-junio-imagen.png'

const Periodico = () => {
  const [open, setOpen] = useState(false);

  return (
    <section id="periodico" class="periodico">
      <div>
